    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 md:p-8">
              ...
              {formStatus === "error" && (
                <div className="mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm">Please try again or contact us directly via phone.</p>
                  </div>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className={`flex items-center justify-center w-full md:w-auto px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors ${
        ...
        <div className="mt-12">
          ...
          <div className="bg-white rounded-xl shadow-sm p-2 h-96">
            {/* Replace with actual map component or iframe */}
            <div className="w-full h-full bg-gray-200 rounded-lg flex items-center justify-center">
              <div className="text-center">
                <MapPin className="h-12 w-12 text-gray-400 mx-auto mb-2" />
                <p className="text-gray-500">Map would be displayed here</p>
                <p className="text-sm text-gray-400">123 Business Avenue, Nairobi, Kenya</p>
              </div>
            </div>
          </div>
        </div>
