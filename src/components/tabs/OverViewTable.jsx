...
import { ShoppingBag, CreditCard, Package, User2, Clock, Edit } from "lucide-react"

const OverviewTab = ({ user, orders, products, userData, formatCurrency, handleEditUser }) => {
          ...
          <div className="space-y-4">
            {recentActivity.map((activity, index) => (
              <div key={index} className="flex items-center justify-between py-3 border-b last:border-0">
                ...
                {activity.amount && <span className="text-sm font-medium text-gray-900">{activity.amount}</span>}
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              onClick={() => {
                ...
                console.log("the is the logged in user to be editted", userToEdit)
