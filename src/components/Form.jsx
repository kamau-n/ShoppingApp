...
//         </p>
//       </div>
//       <p className="text-center font-normal text-slate-700 text-md mt-2 mb-2">
//         Or
//       </p>
//       <button
//         onClick={open}
//         className="bg-blue-500 text-white font-normal p-1 rounded-lg w-auto mx-auto px-4 py-2 text-md">
//         Choose a file
//       </button>
//     </div>
//   );
