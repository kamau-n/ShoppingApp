          ...
          <div className="">
            <div
              ...
              <div className="basis-1/2 flex space-y-5 flex-col justify-center align-middle my-8">
                <h2 className="text-green-300 sm:text-left font-semibold text-2xl">
                  About Us
                </h2>
                ...
                This is an online shop that allows you to order for your favorite products and have them delivered to your doorstep.
                You can order for food, clothes, electronics, and many more.
                </p>
              ...
              <div className="basis-1/2">
                <img
                  src={prod.link}
                  alt="no image"
                  className=" sm:bg-cover mx-auto h-max   rounded-md  "
                />
              </div>
